...
## Commands
- Each command lives in its own module under `commands/` (e.g., `commands/index.py`, `commands/search.py`).
- Co-locate input/output DTOs with their command class in the same file—avoid a separate `commands/models.py`.
